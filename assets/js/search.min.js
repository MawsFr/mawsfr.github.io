!(function() {
  ...
  var i = {
    put: function(t) {
      ...
      if (
        ...
        return (function(t) {
          var e = [];
          s();
          for (var n = 0, r = t.length; n < r; n++) c(t[n]) && e.push(l(t[n]));
          return e;
        })(t);
      var e;
      return;
    ...
    search: function(t) {
      ...
      return (function(t, e, n, r) {
        ...
        return i;
      })(u, t, a.searchStrategy, a).sort(a.sort);
    },
    setOptions: function(t) {
      ((a = t || {}).fuzzy = t.fuzzy || !1),
        (a.limit = t.limit || 10),
        (a.searchStrategy = t.fuzzy ? n : r),
        (a.sort = t.sort || o);
    },
  };
  function o() {
  ...
  (a.fuzzy = !1),
    (a.limit = 10),
    (a.searchStrategy = a.fuzzy ? n : r),
    (a.sort = o);
  var d = {
      compile: function(t) {
        return h.template.replace(h.pattern, function(e, n) {
          var r = h.middleware(n, t[n], h.template);
          return void 0 !== r ? r : t[n] || e;
        });
      },
      setOptions: function(t) {
        (h.pattern = t.pattern || h.pattern),
          (h.template = t.template || h.template),
          'function' == typeof t.middleware && (h.middleware = t.middleware);
      },
    },
    h = {};
  (h.pattern = /\{(.*?)\}/g), (h.template = ''), (h.middleware = function() {});
  var v = {
    merge: function(t, e) {
      var n = {};
  ...
  !(function(e) {
    var n = {
      ...
      r = ['searchInput', 'resultsContainer', 'json'],
      o = (function t(e) {
        if (
          !(function(t) {
    ...
    function c(t) {
      (function(t) {
        ...
        (function(t, e) {
          var r = t.length;
          if (0 === r) return s(n.noResultsText);
          for (var i = 0; i < r; i++) (t[i].query = e), s(d.compile(t[i]));
        })(i.search(t), t));
    }
    function l(t) {
    ...
    e.SimpleJekyllSearch = function(e) {
      ...
      return (
        ...
        v.isJSON(n.json)
          ? u(n.json)
          : ((a = n.json),
            t.load(a, function(t, e) {
              t && l('failed to get JSON (' + a + ')'), u(e);
            })),
        { search: c }
      );
    };
